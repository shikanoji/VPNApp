    ...
    var title: some View {
        HStack {
            Text(L10n.Account.deleteAccount)
                .font(.system(size: Constant.TextSize.DeleteAccountConfirmationView.titleDefault, weight: .bold))
    ...
    var note: some View {
        HStack {
            Text(L10n.Account.DeleteAccount.note)
                .font(.system(size: Constant.TextSize.DeleteAccountConfirmationView.detailDefault, weight: .regular))
